...
public class GeofenceRemover implements
     ...
     */
    private ClientSideUtils.GEOFENCE_REMOVE_TYPE mRequestType;
    ...
    public void removeGeofencesById(List<String> geofenceIds) throws
        ...
        // Set the request type, store the List, and request a location client connection.
            ...
            if (!mInProgress) {
                mRequestType = ClientSideUtils.GEOFENCE_REMOVE_TYPE.LIST;
    ...
    public void removeGeofencesByIntent(PendingIntent requestIntent) {
        ...
        if (!mInProgress) {
            // Set the request type, store the List, and request a location client connection.
            mRequestType = ClientSideUtils.GEOFENCE_REMOVE_TYPE.INTENT;
    ...
    public void onRemoveGeofencesByPendingIntentResult(int statusCode,
        ...
        if (statusCode == LocationStatusCodes.SUCCESS) {
            ...
            Log.d(ClientSideUtils.APPTAG,
                    mContext.getString(R.string.remove_geofences_intent_success));

            // Set the action and add the result message
            broadcastIntent.setAction(ClientSideUtils.ACTION_GEOFENCES_REMOVED);
            broadcastIntent.putExtra(ClientSideUtils.EXTRA_GEOFENCE_STATUS,
                    mContext.getString(R.string.remove_geofences_intent_success));
    ...
    public void onRemoveGeofencesByRequestIdsResult(int statusCode, String[] geofenceRequestIds) {
        ...
        if (LocationStatusCodes.SUCCESS == statusCode) {
            ...
            // In debug mode, log the result
            Log.d(ClientSideUtils.APPTAG, msg);

            // Create an Intent to broadcast to the app
            broadcastIntent.setAction(ClientSideUtils.ACTION_GEOFENCES_REMOVED)
                           .addCategory(ClientSideUtils.CATEGORY_LOCATION_SERVICES)
                           .putExtra(ClientSideUtils.EXTRA_GEOFENCE_STATUS, msg);
    ...
    private void requestDisconnection() {
         ...
         */
        if (mRequestType == ClientSideUtils.GEOFENCE_REMOVE_TYPE.INTENT) {
    ...
    public void onConnected(Bundle arg0) {
        ...
        Log.d(ClientSideUtils.APPTAG, mContext.getString(R.string.connected));
    ...
    public void onDisconnected() {
        ...
        Log.d(ClientSideUtils.APPTAG, mContext.getString(R.string.disconnected));
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        ...
        if (connectionResult.hasResolution()) {
            ...
            try {
                ...
                connectionResult.startResolutionForResult((Activity) mContext,
                    ClientSideUtils.CONNECTION_FAILURE_RESOLUTION_REQUEST);
         ...
         */
            ...
            Intent errorBroadcastIntent = new Intent(ClientSideUtils.ACTION_CONNECTION_ERROR);
            errorBroadcastIntent.addCategory(ClientSideUtils.CATEGORY_LOCATION_SERVICES)
                                .putExtra(ClientSideUtils.EXTRA_CONNECTION_ERROR_CODE,
