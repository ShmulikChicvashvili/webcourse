...
public class GeofenceRequester implements
    ...
    public void onAddGeofencesResult(int statusCode, String[] geofenceRequestIds) {
        ...
        if (LocationStatusCodes.SUCCESS == statusCode) {
            ...
            broadcastIntent.setAction(ClientSideUtils.ACTION_GEOFENCES_ADDED)
    ...
    public void onConnected(Bundle arg0) {
        ...
        Log.d(ClientSideUtils.APPTAG, mActivity.getString(R.string.connected));
    ...
    public void onDisconnected() {
        ...
        Log.d(ClientSideUtils.APPTAG, mActivity.getString(R.string.disconnected));
