...
public abstract class CoolieActivity extends SherlockFragmentActivity  {
	...
	private boolean handleActionBar(Menu menu)
    {
        ...
        settings.setOnMenuItemClickListener(new OnMenuItemClickListener()
        {
			...
			public boolean onMenuItemClick(MenuItem item) {
				Intent intent = new Intent(CoolieActivity.this, PreferencesScreen.class);
	...
	/**
	 * Allow activities to add their own navigation inside the main NavigationDrawer.
	 * The layout will be added only to the activity calls this method.
	 * Different activities can add different navigation layouts.
	 * <br>Pay attention the width of your layout may will be changed.
	 * @param layoutResID - an id <u>from R.layout class</u> witch you want to add to the NavigationDrawer.
	 * @return reference to your inner navigation view.
	 */
	protected View addInnerNavigationDrawer(int layoutResID)
	{
		ViewStub vs = (ViewStub) super.findViewById(R.id.skel_inner_module_nav_container);
		vs.setLayoutResource(layoutResID);
