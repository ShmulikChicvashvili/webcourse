...
public class ContactInformation {
  ...
  /**
   * These fields describe three means of communication with the contact that is
   * to be displayed.
   */
  ...
  public ContactInformation(String firstName, String lastName,
      ...
      String phoneNumber, String techMail, OfficeHour officeHour,
    ...
    timeStamp = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss", Locale.getDefault())
