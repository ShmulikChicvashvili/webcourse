 ...
 * 
 */
public class MyEventsOwnedFragment extends Fragment implements OnFragmentRefresh {
  ...
  @Override public void onRefresh() {
    ...
    ClientProxy.getEventsByOwner(getAccount().getUsername(), new OnDone<List<ClientEvent>>() {
