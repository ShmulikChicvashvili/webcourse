...
public abstract class CoolieServerInterface {
  ...
  public void getStudentCurrentCourses(Student student, Semester semester) {
    ...
    intent.putExtra(CoolieServerInterfaceService.INPUT2,
        new Gson().toJson(semester));
    mContext.startService(intent);
  }
  ...
  public void addTrackingStudent(Student student, CourseKey courseKey) {
    ...
    intent.putExtra(CoolieServerInterfaceService.INPUT,
        new Gson().toJson(student));
    intent.putExtra(CoolieServerInterfaceService.INPUT2,
        new Gson().toJson(courseKey));
    mContext.startService(intent);
  }

  public void removeTrackingStudentFromCourse(Student student,
      CourseKey courseKey) {
    Intent intent = new Intent(mContext, CoolieServerInterfaceService.class);
  ...
  public void addParkingLot(ParkingLot park) {
    ...
    intent.putExtra(CoolieServerInterfaceService.ACTION, action);
    intent
        .putExtra(CoolieServerInterfaceService.INPUT, new Gson().toJson(park));
    mContext.startService(intent);
  }
  ...
  public void addUser(TecUser user) {
    ...
    intent.putExtra(CoolieServerInterfaceService.ACTION, action);
    intent
        .putExtra(CoolieServerInterfaceService.INPUT, new Gson().toJson(user));
    mContext.startService(intent);
  }
