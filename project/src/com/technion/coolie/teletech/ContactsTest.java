...
public class ContactsTest {
	...
	public ContactsTest() {
		...
		ContactInformation contact05 = new ContactInformation("Matan",
				"Hamilis", Position.Assistant, "CS", new OfficeLocation(),
				"0544444444", "smatanham@cs.technion.ac.il", null, null, null);
		...
		ContactInformation contact08 = new ContactInformation("Nader",
				"Bshouty", Position.Professor, "CS", new OfficeLocation(),
				"0529911991", "sbshouty@cs.technion.ac.il", null, null, null);
		...
		ContactInformation contact11 = new ContactInformation("Ron",
				"Rubinstein", Position.Professor, "CS", new OfficeLocation(),
				"0526762327", "sronr@tx.technion.ac.il", null, null, null);
		
		contact11.setID(Long.valueOf(11));
		
		ContactInformation contact12 = new ContactInformation("Jonathan",
				"Yaniv", Position.Assistant, "CS", new OfficeLocation(),
				"0544123551", "srabak@t2.technion.ac.il", null, null, null);
		
		contact12.setID(Long.valueOf(12));
		
		ContactInformation contact13 = new ContactInformation("Mika",
				"Shapira", Position.Staff, "CS", new OfficeLocation(),
				"0555555555", "smika@t2.technion.ac.il", null, null, null);
