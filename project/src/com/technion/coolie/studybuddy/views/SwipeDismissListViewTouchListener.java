...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener
{
	...
	public interface DismissCallbacks
	{
		 ...
		 */
		void onDismiss(NowLayout mListView, int[] reverseSortedPositions);
	}
	 ...
	 */
	public SwipeDismissListViewTouchListener(NowLayout layout,
			DismissCallbacks callbacks)
	{
		ViewConfiguration vc = ViewConfiguration.get(layout.getContext());
		mSlop = vc.getScaledTouchSlop();
		mMinFlingVelocity = vc.getScaledMinimumFlingVelocity() * 16;
		mMaxFlingVelocity = vc.getScaledMaximumFlingVelocity();
		mAnimationTime = layout.getContext().getResources()
