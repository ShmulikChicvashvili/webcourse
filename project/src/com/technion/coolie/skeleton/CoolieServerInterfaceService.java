	...
	protected void onHandleIntent(Intent arg0) {
		...
		switch (action)
		{
			...
			case PARKION_ADD_PARKING_LOT:
			{
				ParkingLot park;
				ReturnCode Output;
				park = new Gson().fromJson((String)arg0.getSerializableExtra(INPUT),ParkingLot.class);
			...
			case TECHOINS_ADD_BANK_ACOUNTS:
			{
				...
				account = new Gson().fromJson((String)arg0.getSerializableExtra(INPUT),BankAccount.class);
			...
			case TECHOINS_GET_BANK_HISTORY:
			{
				...
				intent.putExtra(STATUS, CoolieStatus.RESULT_OK);
				intent.putExtra(CoolieServerInterfaceService.RESULT, new Gson().toJson(OutputList));
				sendBroadcast(intent);
				break;
			}
			...
			case TECHOINS_MOVE_MONEY:
			{
				...
				com.technion.coolie.server.techoins.ReturnCode Output;
				transfer = new Gson().fromJson((String)arg0.getSerializableExtra(INPUT),TechoinsTransfer.class);
			...
			case TECHOINS_GET_PRODUCTS_BY_ID:
			{
				...
				products = new Gson().fromJson((String)arg0.getSerializableExtra(INPUT), new TypeToken<List<Product>>() {
			    }.getType());
			...
			case TECHOINS_GET_PRODUCTS_BY_NAME:
			{
				Product product;
				List<Product> OutputList;
				product = new Gson().fromJson((String)arg0.getSerializableExtra(INPUT),Product.class);
			...
			case TECHOINS_GET_PRODUCTS_BY_CATEGORY:
			{
				...
				OutputList = TechoinsFactory.getTechoinsAPI().getProductsByCategory(product);
				intent.putExtra(STATUS, CoolieStatus.RESULT_OK);
				intent.putExtra(CoolieServerInterfaceService.RESULT, new Gson().toJson(OutputList));
				sendBroadcast(intent);
				break;
			...
			case TECHOINS_GET_SOLD_PRODUCTS_BY_SELLER_ID:
			{
				...
				OutputList = TechoinsFactory.getTechoinsAPI().getSoldProductsBySellerID(product);
				intent.putExtra(STATUS, CoolieStatus.RESULT_OK);
				intent.putExtra(CoolieServerInterfaceService.RESULT, new Gson().toJson(OutputList));
				sendBroadcast(intent);
				break;
			...
			case TECHOINS_GET_PURCHASED_PRODUCTS_BY_BUYER_ID:
			{
				...
				OutputList = TechoinsFactory.getTechoinsAPI().getPurchasedProductsByBuyerID(product);
				intent.putExtra(STATUS, CoolieStatus.RESULT_OK);
				intent.putExtra(CoolieServerInterfaceService.RESULT, new Gson().toJson(OutputList));
				sendBroadcast(intent);
				break;
			...
			case TECHOINS_GET_PUBLISHED_PRODUCTS_BY_SELLER_ID:
			{
				...
				OutputList = TechoinsFactory.getTechoinsAPI().getPublishedProductsBySellerID(product);
				intent.putExtra(STATUS, CoolieStatus.RESULT_OK);
				intent.putExtra(CoolieServerInterfaceService.RESULT, new Gson().toJson(OutputList));
				sendBroadcast(intent);
				break;
			...
			{
				TecUser user;
				user = new Gson().fromJson((String)arg0.getSerializableExtra(INPUT),TecUser.class);
			...
			case TECHMINE_ADD_TOP_BEST_POST:
			{
				...
				topBestPost = new Gson().fromJson((String)arg0.getSerializableExtra(INPUT),TecTopBestPost.class);
				com.technion.coolie.server.techmine.ReturnCode Output;
			...
			case TECHMINE_GET_TOP_BEST_POST:
			{
				TecTopBestPost topBestPost;
				topBestPost = new Gson().fromJson((String)arg0.getSerializableExtra(INPUT),TecTopBestPost.class);
				TecTopBestPost Output;
				Output = TechmineFactory.getTechmineAPI().getTopBestPost(topBestPost);
				intent.putExtra(STATUS, CoolieStatus.RESULT_OK);
				intent.putExtra(CoolieServerInterfaceService.RESULT, new Gson().toJson(Output));
				sendBroadcast(intent);
				break;
			...
			case TECHMINE_ADD_TOP_BEST_COMMENT:
			{
				...
				topBestComment = new Gson().fromJson((String)arg0.getSerializableExtra(INPUT),TecTopBestComment.class);
				com.technion.coolie.server.techmine.ReturnCode Output;
				Output = TechmineFactory.getTechmineAPI().addTopBestComment(topBestComment);
				intent.putExtra(STATUS, CoolieStatus.RESULT_OK);
				intent.putExtra(CoolieServerInterfaceService.RESULT, new Gson().toJson(Output));
				sendBroadcast(intent);
				break;
			...
			case TECHMINE_REMOVE_TOP_BEST_COMMENT:
			{
				...
				topBestComment = new Gson().fromJson((String)arg0.getSerializableExtra(INPUT),TecTopBestComment.class);
				com.technion.coolie.server.techmine.ReturnCode Output;
				Output = TechmineFactory.getTechmineAPI().removeTopBestComment(topBestComment);
				intent.putExtra(STATUS, CoolieStatus.RESULT_OK);
				intent.putExtra(CoolieServerInterfaceService.RESULT, new Gson().toJson(Output));
				sendBroadcast(intent);
				break;
			...
			case TECHMINE_GET_TOP_BEST_COMMENT:
			{
				TecTopBestComment topBestComment;
				topBestComment = new Gson().fromJson((String)arg0.getSerializableExtra(INPUT),TecTopBestComment.class);
				TecTopBestComment Output;
				Output = TechmineFactory.getTechmineAPI().getTopBestComment(topBestComment);
				intent.putExtra(STATUS, CoolieStatus.RESULT_OK);
				intent.putExtra(CoolieServerInterfaceService.RESULT, new Gson().toJson(Output));
				sendBroadcast(intent);
				break;
			...
			{
				TecPost tecPost;
				tecPost = new Gson().fromJson((String)arg0.getSerializableExtra(INPUT),TecPost.class);
				com.technion.coolie.server.techmine.ReturnCode Output;
			...
			case TECHMINE_ADD_TEC_COMMENT:
			{
				...
				tecComment = new Gson().fromJson((String)arg0.getSerializableExtra(INPUT),TecComment.class);
				com.technion.coolie.server.techmine.ReturnCode Output;
			...
			{
				TecLike tecLike;
				tecLike = new Gson().fromJson((String)arg0.getSerializableExtra(INPUT),TecLike.class);
				com.technion.coolie.server.techmine.ReturnCode Output;
