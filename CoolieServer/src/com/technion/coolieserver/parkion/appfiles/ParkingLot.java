...
public class ParkingLot {
  ...
  public ParkingLot(String id1, String name1, double latitude1,
    ...
    this.averageOccupancy = new int[7];
    for (int i = 0; i < 7; i++) {
      for (int j = 0; j <= 23; j++) {
        this.averageOccupancy[i] = averageOccupancy1[i];
      }
    }
    ...
    double temp = averageOccupancy1[day];
  ...
  public void decay() {
    ...
    double temp = currentOccupancy * (1 - ParkingLotConstants.DECAY_RATE)
        + averageOccupancy[day] * ParkingLotConstants.DECAY_RATE;
